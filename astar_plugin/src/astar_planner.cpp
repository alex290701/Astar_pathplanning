...
namespace astar_planner
{
    ...
    void AstarPlanner::getCorrdinate(float &x, float &y)
    {
    ...
    int AstarPlanner::convertToCellIndex(float x, float y)
    {
    ...
    void AstarPlanner::convertToCoordinate(int index, float &x, float &y)
    {
    ...
    bool AstarPlanner::isCellInsideMap(float x, float y)
    {
        bool valid = true;
    ...
    /*********************************************************************************/
    /*
    float AstarPlanner::calculateHCost(int cellID, int goalCell)
    {
